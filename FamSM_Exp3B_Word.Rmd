...
Two participants (6th & 7th) did not make responses in all or most of trials in Block 1. Participants made faster correct responses while maintaining a similar level of accuracy over time. Overall accuracy was `r round(mean(cD1s$M), digits=2)`% (*s.d.* = `r round(sd(cD1s$M), digits=2)`). 
