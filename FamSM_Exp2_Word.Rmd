...
Thirty participants were recruited. Half of the participants were exposed to 24 `words` while the other half were exposed to 24 `pseudowords` (**pre-experimental stimulus familiarity** as a between-participants factor). Each item was repeated eight times, resulting in 192 trials. Participants made a preference judgment (like/dislike) for each item. 
