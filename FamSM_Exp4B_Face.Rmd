...
In the **famous** face condition, source memory was more accurate for **unrepeated** than **repeated** faces. The 95% CI of difference between the means was [`r round(ci95[1], digits=2)`, `r round(ci95[2], digits=2)`]. The table below shows the effect of item repetition for `non-famous` faces.
...
In the `famous` face condition, confidence ratings were higher for **unrepeated** than **repeated** faces. The 95% CI of difference between the means was [`r round(ci95[1], digits=2)`, `r round(ci95[2], digits=2)`]. The table below shows the effect of item repetition for `non-famous` faces.
